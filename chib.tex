...
the value obtained from simulation~\ref{sec:x} without any scaling . The
\chiboneThreeP peak width is fixed to \chiboneTwoP peak width scaled by 1.65.
...
was measured in $18 < p_T^{\Y2S} < 40 \gevc$ interval for merged \sqs=7 and
\sqs=8 \tev data.
...
\chibThreeP yields are smooth decreasing functions of $p_T^{\Y1S}$, as it was
expected.
