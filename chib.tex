...
of $p_T^{\Y1S}$. \Cref{fig:chib:ups1s:conv} 
...
regions, and the observed $\chiboneOneP$ mass is around 6 \mevc lower than the
PDG value.

\input{pics/chib/ups1s_conv_mean}

The systematic uncertainty of $\chibOneP$ yield is around 10\%. The source of
this large uncertainty is due to the signal width which previously was fixed to
the simulation width scaled by 1.6. Another source is the different $\lambda$
value.
