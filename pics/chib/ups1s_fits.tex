...
\begin{figure}[H]
  ...
  \begin{picture}(150,180)
    ...
    \put(75,135){
     ...
     \put(35,37){$22 < p_T^{\Upsilon} < 40 \gevc$}
     \put(35,82){$14 < p_T^{\Upsilon} < 18 \gevc$}
     \put(110,82){$18 < p_T^{\Upsilon} < 22 \gevc$}
     \put(35,127){$10 < p_T^{\Upsilon} < 12 \gevc$}
     \put(110,127){$12 < p_T^{\Upsilon} < 14 \gevc$}
     \put(35,172){$6 < p_T^{\Upsilon} < 8 \gevc$}
     \put(110,172){$8 < p_T^{\Upsilon} < 10 \gevc$}
