...
\midrule
$\chi_b(1P) \to \Y1S \gamma$ & ${}^{+0.9 \%}_{-2.2 \%}$ & ${}^{+0.9 \%}_{-1.8 \%}$ & ${}^{+0.9 \%}_{-3.8 \%}$ & ${}^{+0.9 \%}_{-2.9 \%}$\\

\rule{0pt}{4ex}$\chi_b(2P) \to \Y1S \gamma$ & ${}^{+0.2 \%}_{-0.1 \%}$ & ${}^{+0.3 \%}_{-0.0 \%}$ & ${}^{+0.5 \%}_{-0.2 \%}$ & ${}^{+0.3 \%}_{-0.1 \%}$\\
...
\cmidrule(r){2-3}\cmidrule(r){4-5}
 & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev} & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev}\\
\midrule
$\chi_b(1P) \to \Y1S \gamma$ & ${}^{+1.5 \%}_{-2.9 \%}$ & ${}^{+0.7 \%}_{-2.5 \%}$ & ${}^{+0.6 \%}_{-1.3 \%}$ & ${}^{+0.6 \%}_{-1.5 \%}$\\

\rule{0pt}{4ex}$\chi_b(2P) \to \Y1S \gamma$ & ${}^{+0.2 \%}_{-0.2 \%}$ & ${}^{+0.7 \%}_{-0.0 \%}$ & ${}^{+0.3 \%}_{-0.3 \%}$ & ${}^{+0.2 \%}_{-0.2 \%}$\\

\rule{0pt}{4ex}$\chi_b(3P) \to \Y1S \gamma$ & ${}^{+0.3 \%}_{-0.6 \%}$ & ${}^{+0.2 \%}_{-0.3 \%}$ & ${}^{+0.4 \%}_{-0.5 \%}$ & ${}^{+0.1 \%}_{-0.1 \%}$\\
\bottomrule
\end{tabular}
} % scalebox
...
\cmidrule(r){2-3}\cmidrule(r){4-5}
 & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev} & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev}\\
\midrule
$\chi_b(1P) \to \Y1S \gamma$ & ${}^{+0.5 \%}_{-1.5 \%}$ & ${}^{+0.5 \%}_{-1.1 \%}$ & ${}^{+0.5 \%}_{-1.0 \%}$ & ${}^{+0.8 \%}_{-1.7 \%}$\\

\rule{0pt}{4ex}$\chi_b(2P) \to \Y1S \gamma$ & ${}^{+0.2 \%}_{-0.2 \%}$ & ${}^{+0.2 \%}_{-0.2 \%}$ & ${}^{+0.3 \%}_{-0.3 \%}$ & ${}^{+0.4 \%}_{-0.2 \%}$\\

\rule{0pt}{4ex}$\chi_b(3P) \to \Y1S \gamma$ & ${}^{+0.5 \%}_{-0.3 \%}$ & ${}^{+0.1 \%}_{-0.1 \%}$ & ${}^{+0.2 \%}_{-0.2 \%}$ & ${}^{+0.3 \%}_{-0.2 \%}$\\
\bottomrule
\end{tabular}
} % scalebox
...
\cmidrule(r){2-3}\cmidrule(r){4-5}
 & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev} & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev}\\
\midrule
$\chi_b(1P) \to \Y1S \gamma$ & $\pm 0.162 \%$ & $\pm 0.166 \%$ & $\pm 0.174 \%$ & $\pm 0.174 \%$\\

\rule{0pt}{4ex}$\chi_b(2P) \to \Y1S \gamma$ & $\pm 0.026 \%$ & $\pm 0.020 \%$ & $\pm 0.047 \%$ & $\pm 0.042 \%$\\
...
\cmidrule(r){2-3}\cmidrule(r){4-5}
 & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev} & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev}\\
\midrule
$\chi_b(1P) \to \Y1S \gamma$ & $\pm 0.186 \%$ & $\pm 0.206 \%$ & $\pm 0.215 \%$ & $\pm 0.210 \%$\\

\rule{0pt}{4ex}$\chi_b(2P) \to \Y1S \gamma$ & $\pm 0.044 \%$ & $\pm 0.029 \%$ & $\pm 0.048 \%$ & $\pm 0.043 \%$\\

\rule{0pt}{4ex}$\chi_b(3P) \to \Y1S \gamma$ & $\pm 0.014 \%$ & $\pm 0.011 \%$ & $\pm 0.017 \%$ & $\pm 0.010 \%$\\
\bottomrule
\end{tabular}
} % scalebox
...
\cmidrule(r){2-3}\cmidrule(r){4-5}
 & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev} & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev}\\
\midrule
$\chi_b(1P) \to \Y1S \gamma$ & $\pm 0.234 \%$ & $\pm 0.222 \%$ & $\pm 0.244 \%$ & $\pm 0.232 \%$\\

\rule{0pt}{4ex}$\chi_b(2P) \to \Y1S \gamma$ & $\pm 0.047 \%$ & $\pm 0.035 \%$ & $\pm 0.054 \%$ & $\pm 0.061 \%$\\

\rule{0pt}{4ex}$\chi_b(3P) \to \Y1S \gamma$ & $\pm 0.015 \%$ & $\pm 0.009 \%$ & $\pm 0.026 \%$ & $\pm 0.018 \%$\\
\bottomrule
\end{tabular}
} % scalebox
...
\cmidrule(r){2-3}\cmidrule(r){4-5}
 & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev} & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev}\\
\midrule
$\chi_b(1P) \to \Y1S \gamma$ & $\pm 0.71 \%$ & $\pm 0.73 \%$ & $\pm 0.77 \%$ & $\pm 0.77 \%$\\

\rule{0pt}{4ex}$\chi_b(2P) \to \Y1S \gamma$ & $\pm 0.12 \%$ & $\pm 0.09 \%$ & $\pm 0.21 \%$ & $\pm 0.18 \%$\\
...
\cmidrule(r){2-3}\cmidrule(r){4-5}
 & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev} & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev}\\
\midrule
$\chi_b(1P) \to \Y1S \gamma$ & $\pm 0.82 \%$ & $\pm 0.90 \%$ & $\pm 0.94 \%$ & $\pm 0.92 \%$\\
...
\cmidrule(r){2-3}\cmidrule(r){4-5}
 & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev} & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev}\\
\midrule
$\chi_b(1P) \to \Y1S \gamma$ & $\pm 1.03 \%$ & $\pm 0.97 \%$ & $\pm 1.07 \%$ & $\pm 1.02 \%$\\

\rule{0pt}{4ex}$\chi_b(2P) \to \Y1S \gamma$ & $\pm 0.21 \%$ & $\pm 0.15 \%$ & $\pm 0.24 \%$ & $\pm 0.27 \%$\\

\rule{0pt}{4ex}$\chi_b(3P) \to \Y1S \gamma$ & $\pm 0.07 \%$ & $\pm 0.04 \%$ & $\pm 0.11 \%$ & $\pm 0.08 \%$\\
\bottomrule
\end{tabular}
} % scalebox
...
\cmidrule(r){2-3}\cmidrule(r){4-5}
 & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev} & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev}\\
\midrule
$\chi_b(1P) \to \Y1S \gamma$ & ${}^{+1.0 \%}_{-0.5 \%}$ & ${}^{+1.0 \%}_{-0.6 \%}$ & ${}^{+1.3 \%}_{-0.8 \%}$ & ${}^{+1.3 \%}_{-0.8 \%}$\\
...
\rule{0pt}{4ex}$\chi_b(3P) \to \Y1S \gamma$ & ${}^{+0.2 \%}_{-0.1 \%}$ & ${}^{+0.1 \%}_{-0.1 \%}$ & ${}^{+0.3 \%}_{-0.2 \%}$ & ${}^{+0.2 \%}_{-0.1 \%}$\\
\bottomrule
\end{tabular}
} % scalebox
...
\cmidrule(r){2-3}\cmidrule(r){4-5}
 & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev} & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev}\\
\midrule
$\chi_b(2P) \to \Y2S \gamma$ & ${}^{+0.5 \%}_{-6.8 \%}$ & ${}^{+0.0 \%}_{-4.5 \%}$ & --- & ---\\

\rule{0pt}{4ex}$\chi_b(3P) \to \Y2S \gamma$ & --- & --- & ${}^{+0.2 \%}_{-0.8 \%}$ & ${}^{+0.0 \%}_{-0.6 \%}$\\
\bottomrule
\end{tabular}
} % scalebox
...
\cmidrule(r){2-3}\cmidrule(r){4-5}
 & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev} & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev}\\
\midrule
$\chi_b(2P) \to \Y2S \gamma$ & ${}^{+1.2 \%}_{-4.2 \%}$ & ${}^{+0.6 \%}_{-4.4 \%}$ & ${}^{+0.0 \%}_{-3.7 \%}$ & ${}^{+0.1 \%}_{-6.0 \%}$\\

\rule{0pt}{4ex}$\chi_b(3P) \to \Y2S \gamma$ & --- & --- & ${}^{+0.0 \%}_{-1.2 \%}$ & ${}^{+0.7 \%}_{-0.8 \%}$\\
\bottomrule
\end{tabular}
} % scalebox
