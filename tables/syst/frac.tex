...
\cmidrule(r){2-3}\cmidrule(r){4-5}
 & \sqs = 7\tev & \sqs = 8\tev & \sqs = 7\tev & \sqs = 8\tev\\
\midrule
$\chi_b(1P) \to \Y1S \gamma$ & ${}^{+1.0 \%}_{-1.9 \%}$ & ${}^{+1.4 \%}_{-1.8 \%}$ & ${}^{+0.6 \%}_{-0.9 \%}$ & ${}^{+0.6 \%}_{-0.9 \%}$\\
...
\cmidrule(r){2-3}\cmidrule(r){4-5}
 & \sqs = 7\tev & \sqs = 8\tev & \sqs = 7\tev & \sqs = 8\tev\\
\midrule
$\chi_b(1P) \to \Y1S \gamma$ & ${}^{+1.9 \%}_{-1.8 \%}$ & ${}^{+1.9 \%}_{-1.7 \%}$ & ${}^{+3.2 \%}_{-2.8 \%}$ & ${}^{+3.0 \%}_{-2.6 \%}$\\
...
\cmidrule(r){2-3}\cmidrule(r){4-5}
 & \sqs = 7\tev & \sqs = 8\tev & \sqs = 7\tev & \sqs = 8\tev\\
\midrule
$\chi_b(2P) \to \Y2S \gamma$ & ${}^{+0.7 \%}_{-2.3 \%}$ & ${}^{+0.6 \%}_{-1.9 \%}$ & ${}^{+0.0 \%}_{-0.9 \%}$ & ${}^{+0.1 \%}_{-1.0 \%}$\\
...
\cmidrule(r){2-3}\cmidrule(r){4-5}
 & \sqs = 7\tev & \sqs = 8\tev & \sqs = 7\tev & \sqs = 8\tev\\
\midrule
$\chi_b(2P) \to \Y2S \gamma$ & ${}^{+3.2 \%}_{-3.8 \%}$ & ${}^{+3.5 \%}_{-4.0 \%}$ & --- & ---\\
...
\cmidrule(r){2-3}\cmidrule(r){4-5}
 & \sqs = 7\tev & \sqs = 8\tev & \sqs = 7\tev & \sqs = 8\tev\\
\midrule
$\chi_b(2P) \to \Y2S \gamma$ & ${}^{+4.5 \%}_{-4.1 \%}$ & ${}^{+4.2 \%}_{-3.7 \%}$ & ${}^{+2.8 \%}_{-2.6 \%}$ & ${}^{+3.3 \%}_{-3.2 \%}$\\
...
\cmidrule(r){2-3}
 & \sqs = 7\tev & \sqs = 8\tev\\
\midrule
$\chi_b(3P) \to \Y3S \gamma$ & ${}^{+10.5 \%}_{-11.9 \%}$ & ${}^{+0.0 \%}_{-11.6 \%}$\\
\bottomrule
\end{tabular}
} % scalebox
...
\cmidrule(r){2-3}
 & \sqs = 7\tev & \sqs = 8\tev\\
\midrule
$\chi_b(3P) \to \Y3S \gamma$ & ${}^{+9.3 \%}_{-7.5 \%}$ & ${}^{+9.4 \%}_{-7.7 \%}$\\
\bottomrule
\end{tabular}
} % scalebox
