...
\begin{table}[H]
\centering
\caption{\small Nominal fits for $\Upsilon$}
...
\scalebox{0.8}{
    ...
    \rule{0pt}{4ex} B  && 294,300 $\pm$ 700 & 716,100 $\pm$ 1100 \\
    \rule{0pt}{4ex} $\mu_{\Y1S}$  && 9456.64 $\pm$ 0.09 & 9455.24 $\pm$ 0.06 \\
     $\sigma_{\Y1S}$  && 45.23 $\pm$ 0.08 & 45.38 $\pm$ 0.06 \\
    \rule{0pt}{4ex} $\chi^2/ndf$  && 9.01 & 18.00 \\

    \bottomrule
    \end{tabular}
} % scalebox

\label{tab:ups:nominal2}
\end{table}
