...
\cmidrule(r){2-3}\cmidrule(r){4-5}\cmidrule(r){6-7}\cmidrule(r){8-9}
 & \multicolumn{1}{c}{\sqs=7\tev} & \multicolumn{1}{c}{\sqs=8\tev} & \multicolumn{1}{c}{\sqs=7\tev} & \multicolumn{1}{c}{\sqs=8\tev} & \multicolumn{1}{c}{\sqs=7\tev} & \multicolumn{1}{c}{\sqs=8\tev} & \multicolumn{1}{c}{\sqs=7\tev} & \multicolumn{1}{c}{\sqs=8\tev}\\
\midrule
$N_{\chi_{b1}(3P)}^{MC}$ & 287 $\pm$ 18 & 245 $\pm$ 17 & 250 $\pm$ 17 & 243 $\pm$ 17 & 339 $\pm$ 19 & 272 $\pm$ 18 & 276 $\pm$ 18 & 299 $\pm$ 20\\
$N_{\Upsilon(3S)}^{MC}$ from $\chi_{b1}(3P)$ & 4080 $\pm$ 60 & 3800 $\pm$ 60 & 2390 $\pm$ 50 & 2160 $\pm$ 50 & 2330 $\pm$ 50 & 2140 $\pm$ 50 & 1490 $\pm$ 40 & 1390 $\pm$ 40\\
$\varepsilon_{\chi_{b1}(3P)}^{\gamma}$, \% & \textbf{7.0 $\pm$ 0.5} & \textbf{6.4 $\pm$ 0.5} & \textbf{10.5 $\pm$ 0.7} & \textbf{11.2 $\pm$ 0.8} & \textbf{14.6 $\pm$ 0.9} & \textbf{12.7 $\pm$ 0.9} & \textbf{18.5 $\pm$ 1.3} & \textbf{21.5 $\pm$ 1.5}\\

\rule{0pt}{4ex}$N_{\chi_{b2}(3P)}^{MC}$ & 73 $\pm$ 9 & 89 $\pm$ 10 & 62 $\pm$ 9 & 55 $\pm$ 8 & 76 $\pm$ 9 & 56 $\pm$ 8 & 48 $\pm$ 7 & 42 $\pm$ 7\\
$N_{\Upsilon(3S)}^{MC}$ from $\chi_{b2}(3P)$ & 970 $\pm$ 31 & 969 $\pm$ 31 & 542 $\pm$ 23 & 499 $\pm$ 22 & 497 $\pm$ 22 & 442 $\pm$ 21 & 243 $\pm$ 16 & 215 $\pm$ 15\\
$\varepsilon_{\chi_{b2}(3P)}^{\gamma}$, \% & \textbf{7.5 $\pm$ 1.0} & \textbf{9.2 $\pm$ 1.1} & \textbf{11.5 $\pm$ 1.8} & \textbf{11.1 $\pm$ 1.7} & \textbf{15.3 $\pm$ 2.0} & \textbf{12.7 $\pm$ 1.9} & \textbf{19.8 $\pm$ 3.3} & \textbf{19.5 $\pm$ 3.5}\\
\midrule
$\varepsilon_{\chi_{b1,2}(3P)}^{\gamma}$, \%  & \textbf{7.3 $\pm$ 0.5} & \textbf{7.8 $\pm$ 0.6} & \textbf{11.0 $\pm$ 1.0} & \textbf{11.2 $\pm$ 0.9} & \textbf{14.9 $\pm$ 1.1} & \textbf{12.7 $\pm$ 1.1} & \textbf{19.1 $\pm$ 1.8} & \textbf{20.5 $\pm$ 1.9}\\
\bottomrule
\end{tabular}
} % scalebox
