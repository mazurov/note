...
\cmidrule(r){2-3}
 & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev}\\
\midrule
$\chi_b(2P) \to \Y2S \gamma$ & 33 $\pm$ 6\stat${}^{+3.3}_{-5.2}\syst^{+3.0}_{-2.9}\systpol \%$ & 34 $\pm$ 4\stat${}^{+2.1}_{-3.2}\syst^{+3.1}_{-3.0}\systpol \%$\\
...
\rule{0pt}{4ex}$\chi_b(3P) \to \Y2S \gamma$ & 4.3 $\pm$ 1.6\stat${}^{+0.4}_{-0.6}\syst^{+0.1}_{-0.1}\systpol \%$ & 2.6 $\pm$ 1.0\stat${}^{+0.2}_{-0.3}\syst^{+0.1}_{-0.1}\systpol \%$\\
\bottomrule
\end{tabular}
} % scalebox/resizebox
