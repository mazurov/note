...
theory, is varied from 0.5 to 0.8 as it was discussed in~\Cref{sec:ratio}.
...
\Cref{tab:syst:sigma_ups1s,tab:syst:sigma2p_ups2s,tab:syst:sigma3p_ups3s}
...
in~\Cref{tab:syst}. 
% For simplicity,
% \Cref{tab:syst} shows only the maximum systematic uncertainties observed  
...
which gives an uncertainty of 1\mevcc in \decay{\chibthreep}{\Y3S\g}~decays.
...
%
The~\chiboneThreeP mass exhibit (\Cref{fig:chib-3s:m3p}) the linear dependency on the assumed
