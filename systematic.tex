...
\input{tables/syst/ups1s}
\input{tables/syst/ups2s}
\input{tables/syst/ups3s}

% \input{tables/syst/lambda_ups1s}
% \input{tables/syst/lambda_ups2s}
% \input{tables/syst/m1p_ups1s}
% \input{tables/syst/m2p_ups2s}
% \input{tables/syst/m3p_ups1s}
% \input{tables/syst/m3p_ups2s}
