...
in~\Cref{tab:syst:common,tab:syst:summary}. For simplicity, \Cref{tab:syst:summary} 
shows only maximum deviation of systematic uncertainty in all bins for the corresponding decays.
